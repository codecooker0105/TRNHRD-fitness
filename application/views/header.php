    ...
    <body class="land_body" id="landing_page_body">
        ...
        <?php } else { ?>
            ...
            <body class="page_body">
                <div id="container">
                    <div id="header">
                        <?php if ($this->ion_auth->logged_in()) { ?><a href="/member">
                            <?php } else { ?><a href="/">
                                <?php } ?><img src="/assets/images/logo.png" id="logo" title="Trnhrd" alt="Trnhrd" />
                            </a>
                            <div id="login">
                                ...
                                <?php } else { ?>
                                    <div id="have_account">Have an account?</div> <a href="/member/login"
                                        class="login_link">Sign In</a>
                                <?php } ?>
                            </div>
                            <div id="menu_container">
                                <?php if ($this->ion_auth->logged_in()) { ?>
                                    <ul id="menu">
                                        ...
                                        <?php if ($this->ion_auth->is_group('trainers')) { ?>
                                            <li><a href="/member/workout_generator">Workout Generator</a></li>
                                        <?php } ?>
