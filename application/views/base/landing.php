...
<section class="ptb-xs-40 explanation">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 pt-70 pt-xs-40 mb-sm-30 mb-xs-30">
      ...
      <div class="col-lg-4 col-md-6 pt-70 pt-sm-20 mb-xs-30">
        <div class="process_box">
          <div class="process_detail">
            <div class="header_detail">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12">
        <div>
          ...
          <h2 class="fitness_to_live_title">
...
<section class="padding ptb-xs-40 explanation">
  <div class="row" style="margin: 0;">
    ...
    <div class="col-md-9 col-sm-12 traning_part">
      <h2>PERSONAL TRANING AND EXPERT</h2>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-7 col-sm-7 col-xs-12">
        ...
        <img class="testimonial_colon" src="/assets/images/colon.png" alt="" />
      </div>
    </div>
  </div>
</section>
