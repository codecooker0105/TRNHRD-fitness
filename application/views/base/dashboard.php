...
<!-- Intro Section -->
<section
  class="inner-intro bg-img-home light-color overlay-before parallax-background"
>
  <div class="container">
    <div class="row title">
      <div class="title_row">
  ...
  <div class="row" style="margin: 0;">
    <div class="col-lg-2" style="background: white;">
      <div class="account-profile">
        <div>
          <? if($user->photo != "") { ?>
          <img src="/images/member_photos/<? echo $user->photo; ?>" class="avatar-img" alt="avatar">
          <? } else { ?>
            ...
            <div id="MainMenu2">
              <div class="list-group panel">
                <div id="demo3">
                  ...
                  <a href="#category2" class="list-group-item" data-toggle="collapse" data-parent="#2">Account Functions<i class="fa fa-caret-down"></i></a>
    ...
    <div class="col-lg-2" style="background: white;">
      ...
      <div class="account-profile">
        ...
        <div>
          <? if($trainer->photo != ""){ ?>
            <img src="/images/member_photos/<? echo $trainer->photo; ?>" class="avatar-img" alt="avatar" />
          <? }else{ ?>
            <img src="/images/template/no_photo.jpg" class="avatar-img" alt="avatar" />
          <? } ?>
