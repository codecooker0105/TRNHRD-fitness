<div class='mainInfo'>
	...
	<?php foreach ($users as $user):?>
        <tr>
            ...
            <td><?php echo anchor("admin/edit_user/". $user['id'], 'Edit');?> | <?php echo anchor("admin/edit_password/". $user['id'], 'Password');?> | <a href="#" class="delete_member" id="member<?=$user['id']?>">Delete</a></td>
        </tr>
    <?php endforeach;?>
	</table>
