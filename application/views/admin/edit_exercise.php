<div class='mainInfo'>
    ...
    <?php echo form_open_multipart("admin/edit_exercise/".$this->uri->segment(3));?>
      ...
      <? echo form_multiselect('exercise_muscles[]',$muscle_options,$exercise_muscles,'style="width:150px;height:200px;"'); ?>
      </p>
      
      <p>Exercise Categories: (hold ctrl to select multiple)<br />
      <? echo form_multiselect('exercise_types[]',$type_options,$exercise_types,'style="width:150px;height:200px;"'); ?>
      </p>
      
      <p>Exercise Equipment: (hold ctrl to select multiple)<br />
      <? echo form_multiselect('exercise_equipment[]',$equipment_options,$exercise_equipment,'style="width:150px;height:200px;"'); ?>
      </p>
