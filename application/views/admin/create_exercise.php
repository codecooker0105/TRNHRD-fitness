<div class='mainInfo'>
    ...
    <?php echo form_open_multipart("admin/create_exercise");?>
      ...
      <tr>
          ...
          <?php echo form_multiselect('exercise_muscles[]',$muscle_options,$exercise_muscles,'style="width:200px;height:250px;"'); ?>
          </p>
       	</td>
        <td width="33%" valign="top">      
          <p>Exercise Categories: (hold ctrl to select multiple)<br />
          <?php echo form_multiselect('exercise_types[]',$type_options,$exercise_types,'style="width:200px;height:250px;"'); ?>
          </p>
      	</td>
        <td width="33%" valign="top">
          <p>Exercise Equipment: (hold ctrl to select multiple)<br />
          <?php echo form_multiselect('exercise_equipment[]',$equipment_options,$exercise_equipment,'style="width:200px;height:250px;"'); ?>
          </p>
        </td>
      </tr>
      </table>
