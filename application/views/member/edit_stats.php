...
<p>Below is the list of stats you are currently tracking besides the workout progression that Hybrid Fitness tracks for
  you. You can add any kind of statistic here and we will keeptrack of it. Examples of stats might be your weight, max
  lift of bench press or body fat percentage.</p>
...
<table cellpadding="0" cellspacing="0" class="listing tablesorter" id="stats" width="100%">
  ...
  <?php foreach ($stats as $count => $stat): ?>
    <tr id="stat<?= $stat->id ?>" class="<?= ($count % 2) ? 'odd' : 'even'; ?>">
      ...
      <td align="center"><a class="confirmDeleteLink" href="<?= site_url('member/remove_stat/' . $stat->id) ?>">Remove
          Stat</a></td>
    </tr>
  <?php endforeach; ?>
</table>
