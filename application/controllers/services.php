...
class Services extends REST_Controller
{
	...
	function login_post()
	{
		...
		if (isset($body['username']) && isset($body['password'])) { //check to see if the user is logging in
	...
	function submituserworkout_form()
	{
		...
		$this->data['uwe_id'] = array(
			'name' => 'UserWorkoutExerciseId',
			'type' => 'text'
		);
