...
class Member extends Controller
{
    ...
    /**
     * Author: conda
     * TODO: get my clinet with respect to user id
     * @param user_id
     * * Method: GET
     */
    function clients()
        ...
        if ($user && $user->group_id == 3) {
            ...
            if ($mailDetail && $mailDetail['group_id'] == 2) {
                ...
                if ($error_message == '' && $this->form_validation->run() == true) { //check to see if we are creating the user
                    ...
                    $this->email->from($this->config->item('admin_email', 'ion_auth'), 'Hybrid Fitness on behalf of ' . $data['trainer_name']);
                    $this->email->to($this->input->post('email'));
                    $this->email->subject('Hybrid Fitness - Trainer Request');
...
//        $this->form_validation->set_rules('username', 'Username', 'required');
    ...
    /**
     * Author: conda
     * TODO: first-run Progression Plan (First Time Member Logged in)
     * @param user_id
     * @param progression_plan_id
     * @param workoutdays
     * @param exp_level_id
     ...
     * Author: conda
     * * GET method
     * TODO get Workout Exercises Based on ID
...
//                $this->ci->email->message($message);
                ...
                $email->setFrom("no-reply@hybridfitness.com", "Hybrid Fitness");
...
//                'zip' => $this->input->post('zip')
    ...
    /**
     * Author: conda
     * TODO: get sample workout
     * @param user_id
     * @param skeleton_workout_id
     ...
     * Author: conda
     * * GET method
     * TODO get exercise with respect to user id, progression id, and so on
     * @param user_id
     * @param progression_id
