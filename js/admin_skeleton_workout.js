    ...
    $("#dialog").dialog({
      ...
      buttons: {
        "Add New Section": function () {
          ...
          if (bValid) {
            $("#workout_list").append(
              '<li class="section"><span class="move ui-icon ui-icon-arrowthick-2-n-s"></span><span class="title">' +
                $("#section_dropdown").val() +
                '</span><span class="remove ui-icon ui-icon-circle-close"></span><ul class="categories"></ul></li>'
            );
            updateWorkoutListControls();
            $(this).dialog("close");
          }
    ...
    $("#exercise_dialog").dialog({
      ...
      buttons: {
        "Add New Exercise": function () {
          ...
          if (bValid) {
            $.post(
              "/member/get_admin_exercise_type",
              { id: $("#exercise_type_dropdown").val() },
              function (data) {
